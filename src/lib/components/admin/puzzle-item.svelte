        ...
        <form class="p-2" action="javascript:">
          <div class="d-flex mb-2">
            <div class="input-group input-group-sm pe-2">
              <span class="edit-puzzle-field-size input-group-text">Level</span>
              <input type="text" class="form-control" />
            </div>
            <div class="input-group input-group-sm">
              <span class="edit-puzzle-field-size input-group-text">Image</span>
              <input type="file" class="form-control" />
            </div>
          </div>
          <div class="d-flex">
            <div class="input-group input-group-sm pe-2">
              <span class="edit-puzzle-field-size input-group-text">Answer</span
              >
              <input type="text" class="form-control" />
            </div>
            <div class="input-group input-group-sm">
